...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * Utility class for JWT operations (generating, validating, extracting).  Injected via
     * constructor injection.
     */
    private final JwtUtil jwtUtil;
    /**
     * Repository for accessing user data.  Used to retrieve user details based on the email
     * extracted from the JWT.  Injected via constructor injection.
     */
